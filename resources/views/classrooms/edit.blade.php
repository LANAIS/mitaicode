...
@section('content')
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-4">Editar Información de la Clase</h5>

                    <form action="{{ route('classrooms.update', $classroom->class_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('access_code') is-invalid @enderror" 
                                    id="access_code" name="access_code" value="{{ old('access_code', $classroom->access_code) }}">
                                <button class="btn btn-outline-secondary" type="button" id="generate-code">Generar Nuevo</button>
                            </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('classrooms.show', $classroom->class_id) }}" class="btn btn-outline-secondary me-2">Cancelar</a>
